...
shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
        h3('Instructions'),
        p('Please input the gross horsepower, number of cylinders, and weight of your 
          car below.  The predicted MPG will be shown to the right graphics.'),
        h3('Please input predictors of MPG below.'),
    ...
    mainPanel(
        h6('Course Project by Li Jiming'),
        h3('Predicted MPG'),ShowDateTime(),
        h4('Your inputs:'),
